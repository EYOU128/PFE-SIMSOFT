...
const PRODUCTS: Product[] = [
  {
    ...
    name: 'Divalto ERP',
    tag: 'ERP',
    tagline: "L'ERP modulaire qui pilote toute votre entreprise — finance, ventes, achats, production et BI dans une seule plateforme.",
    hero: 'from-blue-600 via-indigo-600 to-cyan-500',
    icon: 'boxes',
    overview: "Divalto est un ERP français leader dédié aux PME et ETI. Sa plateforme modulaire couvre la totalité des processus de gestion : finance, comptabilité, achats, ventes, stocks, production, CRM, BI et mobilité. SIMSOFT intègre Divalto sur mesure pour adapter l'outil à vos métiers et accélérer votre transformation digitale.",
    objectives: [
  ...
  },
  {
    ...
    name: 'FirstParc GMAO',
    tag: 'GMAO',
    tagline: 'La GMAO nouvelle génération pour piloter votre maintenance préventive, curative et la performance de vos actifs.',
    hero: 'from-emerald-600 via-teal-600 to-cyan-500',
    icon: 'wrench',
    overview: "FirstParc est une solution de Gestion de Maintenance Assistée par Ordinateur (GMAO) complète et mobile. Elle pilote la maintenance préventive, curative et conditionnelle de votre parc d'équipements, optimise la disponibilité des actifs et réduit drastiquement les coûts de maintenance.",
    objectives: [
  ...
  },
  {
    ...
    name: 'WaveSoft',
    tag: 'Gestion',
    tagline: 'La suite de gestion commerciale et comptable conçue pour les TPE/PME ambitieuses.',
    hero: 'from-violet-600 via-purple-600 to-fuchsia-500',
    icon: 'LineChart',
    overview: "WaveSoft est une suite logicielle complète qui couvre la gestion commerciale, la comptabilité, la paie et le CRM des TPE et PME. Modulaire, simple à prendre en main et 100% conforme à la réglementation française, elle accompagne la croissance de votre entreprise sans complexité inutile.",
    objectives: [
  ...
  },
  {
    ...
    name: 'Quorion POS',
    tag: 'POS',
    tagline: "Les solutions d'encaissement professionnelles allemandes pour retail, restauration et hôtellerie.",
    hero: 'from-amber-500 via-orange-600 to-red-500',
    icon: 'layout-grid', 
    overview: "Quorion est un fabricant allemand de caisses enregistreuses tactiles haut de gamme. Robustes, certifiées NF525 et entièrement configurables, les solutions Quorion répondent aux exigences du retail, de la restauration et de l'hôtellerie. SIMSOFT distribue, installe et personnalise Quorion en Tunisie.",
    objectives: [
  ...
  },
  {
    ...
    tag: 'Custom',
    tagline: 'Des logiciels métiers sur mesure conçus autour de vos processus — web, mobile, IA et intégration.',
    hero: 'from-pink-600 via-rose-600 to-orange-500',
    icon: 'cpu',
    overview: "Quand les progiciels du marché ne répondent pas à vos enjeux métiers, SIMSOFT conçoit, développe et maintient des applications sur mesure. Notre équipe pluridisciplinaire (UX, dev, data, IA) couvre tout le cycle de vie : cadrage, prototypage, build, run et évolutions.",
    objectives: [
    ...
    features: [
      ...
      { icon: 'Cpu', title: 'IA & LLM', desc: 'Chatbots, RAG, vision, NLP, automatisation intelligente.' },
  ...
  },
  {
    ...
    tag: 'Support',
    tagline: 'Support, infogérance et maintenance applicative en continu — vos systèmes toujours opérationnels.',
    hero: 'from-sky-600 via-blue-600 to-indigo-500',
    icon: 'headphones',
    overview: "SIMSOFT propose un service d'assistance technique 24/7 couvrant vos ERP, GMAO, POS, infrastructure et applications métiers. Nos ingénieurs certifiés interviennent à distance et sur site, avec des SLA garantis et un portail self-service moderne.",
    objectives: [
...
export class ProductService {
  ...
  getAdjacent(slug: string): { prev: Product | null; next: Product | null } {
